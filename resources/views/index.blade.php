...
<body>
	...
	<table border="6" align="center" width="60%" class="table table-bordered">
		<th>Companies</th>
		<tr>
			<td class="tc"><form action="/companies/create"><button type="submit" class="btn btn-success">Create new company</button></form>
								...
								<th> </th>
									...
									@foreach($companies as $compani)
										<tr>
											...
											<td><form action="/companies/{{ $compani->id }}/edit"><button type="submit" class="btn btn-outline-dark">Edit</button></form><form method="POST" action="/companies/{{ $compani->id }}">
												@method('DELETE')
												@csrf
